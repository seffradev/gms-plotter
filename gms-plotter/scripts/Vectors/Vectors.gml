...
/// @function			vector2d_from_coords(x1, y1, x2, y2);
...
function vector2d_from_angle(length, angle) {
	return { _x1: 0, _y1: 0, _x2: length * cos(angle), _y2: length * sin(angle) };
}
...
/// @function			vector3d_from_coords(x1, y1, z1, x2, y2, z2);
/// @param {real} x1	x-coordinate of first point
/// @param {real} y1	y-coordinate of first point
